...
|---|---|---|
| `hi` | `{online, features:{groundLoot:1,progression:1,autoloot:1,crafting:1,nativeOnly:1,rates:1}, rates:{xp,sp,coins,…}}` | сразу после соединения (по нему же работает проба `server_probe.gd`) |
...
опыта, SP, монет, дропа, цен, заточки, крафта, респавна и бонуса группы. Значения считает и
